...
import de.gontrix.farmingcompost.common.blocks.CompostBlock;
...
public class Items {
    ...
    public static final RegistryObject<Item> COMPOST = ITEMS.register(CompostBlock.NAME, CompostItem::new);
